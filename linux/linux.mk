...
ifeq ($(BR2_LINUX_KERNEL_INSTALL_CONFIG_TO_IMAGES),y)
define LINUX_INSTALL_CONFIG_TO_IMAGES
	$(INSTALL) -m 0644 -D $(@D)/.config $(1)/$(notdir linux.config)
endef
endif
...
define LINUX_INSTALL_IMAGES_CMDS
	...
	$(call LINUX_INSTALL_CONFIG_TO_IMAGES,$(BINARIES_DIR))
endef
